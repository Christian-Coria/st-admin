...
class Consulta(models.Model):
    ...
    estado_respuesta = models.CharField(max_length=15,blank=True, null=True, choices = ESTADOS, default='No Contestada')
    ...
    def estado_de_respuesta(self,):
        if self.estado_respuesta == 'Contestada':
            ...
            return format_html('<span style="background-color:#FOB203; color:#fff; padding:5px;">{}</span>', self.estado_respuesta,)
...
class Respuesta(models.Model):
    ...
    def create_mensaje(self,):
        ...
        #logica de envio de la respuesta!!!
